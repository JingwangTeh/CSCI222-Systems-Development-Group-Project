...
//	normal
	...
	public String addAnswer(){
		...
		user.setReputationByAnswer(user.getReputationByAnswer()+1);
		userService.updateUser(user);
		return "success";
	}
...
//		insert data into question_target table
	...
	public String acceptAnswer(){
		questionService.acceptAnswer(question.getId(),answerId);
		return "success";
	}
	...
	public String repeat(){
		questionService.repeat(question.getId(),questionId);
		return "success";
	}
	
	public String hidden(){
		questionService.hidden(question.getId());
		return "success";
	}
