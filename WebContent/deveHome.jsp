...
<head>
	...
	<link rel="stylesheet" href="https://cdn.datatables.net/1.10.12/css/dataTables.bootstrap.min.css">
  	...
  	<script type="text/javascript">
  	 $(document).ready(function(){
			var path = $("#path").val();
			$.ajax({  
	           url:path+'/bug/viewAssignBug.action',  
	           type:'POST',  
	           data:"",  
	           dataType:'json',  
	...
	<input id="path" type="hidden"
		...
		<div class="container">
			<div id="header">
				<div id="titleName">
					<a href="./home.html"><img src="${pageContext.request.contextPath }/img/bug.png" id="uniIcon"/></a>
				</div>
		        ...
		        <div class="col-md-4">
		            ...
		            <h5><i class="glyphicon glyphicon-user"></i>
		                ...
		                <ul class="nav nav-pills nav-stacked">
		                    ...
		                    <li><a href="${pageContext.request.contextPath }/report.jsp">Report bug</a></li>
		                </ul>
